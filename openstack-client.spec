...
Source0:          python-novaclient-%{os_release}-%{version}.tar.gz
...
%package -n       python-novaclient-%{os_release}
...
%description -n   python-novaclient-%{os_release}
This is a client for the OpenStack Nova API. There's a Python API (the
novaclient module), and a command-line script (nova). Each implements 100% of
the OpenStack Nova API.
...
%prep
%setup -q -n python-novaclient-%{os_release}-%{version}
...
%files -n python-novaclient-%{os_release}
%defattr(-,root,root,-)
